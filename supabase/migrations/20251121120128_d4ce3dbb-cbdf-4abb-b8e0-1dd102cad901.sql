-- Fix handle_new_user function to assign hunter role
...
-- Backfill hunter role for existing hunters who don't have it
INSERT INTO public.user_roles (user_id, role)
SELECT id, 'hunter'::app_role
FROM public.profiles
WHERE user_type = 'hunter'
  AND id NOT IN (
    SELECT user_id 
